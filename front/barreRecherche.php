    ...
    <div class="container-fluid py-2">
        ...
        <form class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="ville" placeholder="Entrez la ville de départ">
            </div>

            <!-- Champ Ville d'arrivé -->
            <div class="col-md-3">
                <label for="ville" class="form-label text-white">Ville d'arrivé</label>
                <input type="text" class="form-control" id="ville" placeholder="Entrez la ville d'arrivé">
            </div>
